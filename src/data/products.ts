...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'mf-gift-box',
    name: 'MOURYA FOODS Royal Festival & Corporate Gift Box',
    variant: '4 x 100g Assorted Luxury Rigid Box',
    sku: 'MF-GIFT-01',
    gtinBarcode: '8908027734091',
    price: 799,
    mrp: 999,
    weight: '400g',
    weightInGrams: 400,
    ...
    description: 'Luxurious gold foil rigid gift box containing 4 flavor pouches: Himalayan Salt, Peri Peri, Pudina, and Premium Raw Makhana.',
    inStock: true,
    rating: 5.0,
    reviewsCount: 64,
  }
...
export const NUTRITION_FACTS = [
  { nutrient: 'Energy', valuePer100g: '347 kcal', highlight: true },
  { nutrient: 'Protein', valuePer100g: '9.7 g', highlight: true },
  { nutrient: 'Carbohydrates', valuePer100g: '76.9 g', highlight: false },
  { nutrient: 'Dietary Fiber', valuePer100g: '14.5 g', highlight: true },
  { nutrient: 'Total Fat', valuePer100g: '0.5 g (Very Low)', highlight: true },
  { nutrient: 'Calcium', valuePer100g: '60 mg', highlight: false },
  { nutrient: 'Iron', valuePer100g: '1.4 mg', highlight: false },
